...
export type RegionId = 'lago' | 'floresta';
...
export const MISSIONS: readonly MissionDef[] = [
  ...
  // ---------- Floresta Noturna: a mira é a lanterna ----------
  {
    ...
    round: { ducks: 8, speed: 1.0, escape: 1.1, turn: [2400, 3400], armored: 0, shy: 0 },
    objectives: [{ kind: 'hits', value: 5 }, { kind: 'accuracy', value: 0.6 }, { kind: 'noSuper' }],
  },
  {
    id: 'floresta-2', region: 'floresta', index: 1, name: 'Sombras Rápidas',
    round: { ducks: 10, speed: 1.3, escape: 1.0, turn: [1900, 2800], armored: 0, shy: 0 },
    objectives: [{ kind: 'hits', value: 6 }, { kind: 'noEscape' }, { kind: 'accuracy', value: 0.65 }],
  },
  {
    id: 'floresta-3', region: 'floresta', index: 2, name: 'Os Tímidos',
    round: { ducks: 10, speed: 1.2, escape: 1.0, turn: [2000, 3000], armored: 0, shy: 4 },
  ...
  },
  {
    ...
    round: { ducks: 12, speed: 1.45, escape: 0.95, turn: [1500, 2400], armored: 2, shy: 3 },
